...
const Footer = () => {
  ...
  const { social_media, primary_font, contact_number, email, name, address } =
    office!;
  return (
    <footer className={cn("[var(--bg-1)]", primary_font)}>
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li>
                  <div className="flex items-center gap-4">
                    ...
                    <p className="mb-0 clr-neutral-30">{address}</p>
                  </div>
                </li>
              </ul>
            </div>
